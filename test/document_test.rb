...
class DocumentTest < Test::Unit::TestCase
  ...
  def test_basics
    ...
    documents << Document.new(@fonts[1], style, Document::CS_PC, Document::LC_ENGLISH_US)

    lr_margin = DocumentStyle::DEFAULT_LEFT_MARGIN + DocumentStyle::DEFAULT_RIGHT_MARGIN
    tb_margin = DocumentStyle::DEFAULT_TOP_MARGIN + DocumentStyle::DEFAULT_BOTTOM_MARGIN
